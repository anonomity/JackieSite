...
<MediumPic img={code} size={900} alt="code" />  
...
<MediumPic img={compare} size={900} alt="difference between scriptable vs mono" />  

so the only new method you get is OnDestoy() and you don't have access to the game loop through functions like
update and start
