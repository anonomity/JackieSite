...
<SideNote title="Inheritance" text="Inheritance is an object oriented concept, it's what happens when one script gets methods / variables  from anothers script, for example lets say we have an Animals scripts and in this script we have the method 
