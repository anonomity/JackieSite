...
at all, the backend doesn't need to know who these subscribers are or what they're doing.

For instance, I can have backend code that sets off an event when
